                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="notiItem">
                                ...
                                <p class="mb-0">You have received a message form John Mark</p>
                            </div>
                            <div class="notiItem">
                                <div class="ntfydate">
                                    18<br/>Nov
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="notiItem">
                                ...
                                <p class="mb-0 fw-500 text-black">You have received a message form John Mark</p>
                            </div>
                            <div class="notiItem">
                                <div class="ntfydate">
                                    18<br/>Nov
                                </div>
                                <p class="mb-0 fw-500 text-black">You have received a message for booking confirmation</p>
                            </div>
                        </div>
                    </div>
                </div>
