        ...
        <tr>
            <td bgcolor="#BA424D" style="padding: 20px 0;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="center" style="font-family: 'Roboto', sa" ns-serif; color: #fff; font-size: 16px;">Copyright &copy; 2024 Co-Living</td>
                    </tr>
                </table>
...
<body style="margin:10px; background:#fff;">
  ...
  const mailOptions = {
    from: "dev@waysaheadglobal.com",
    to: email,
    subject:`Co-Living: Account ${status}`,
    html: HTML,
  };
  await transporter.sendMail(mailOptions, function (error, info) {
    if (error) {
...
<body style="margin:10px; background:#fff;">
  ...
  const mailOptions = {
    from: "dev@waysaheadglobal.com",
    to: email,
    subject:`Co-Living: Property ${status}`,
    html: HTML,
  };
  await transporter.sendMail(mailOptions, function (error, info) {
    if (error) {
...
module.exports = {
  ...
  sendPropertyOwnerApproveRejectEmail
};
